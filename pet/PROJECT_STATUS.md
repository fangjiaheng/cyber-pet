...
当前最明确的未解问题，是窗口拖到屏幕顶部时，宠物上方仍然会保留一段不可到达区域。

这大概率不是单一常量造成的，而是下面几个因素叠加：
...
这个问题已经进入待办，后续需要结合主进程窗口边界和渲染层实际布局一起排查。
...
1. 先解决“拖到屏幕顶部仍有留白”的窗口边界问题
2. 继续收敛动作状态机，减少业务层分散的定时器
3. 开始准备原创化替换方案，把项目从“原版素材验证原型”过渡到“可公开发布的原创萌宠”
